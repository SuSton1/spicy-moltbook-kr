...
export const TP12_SIDE_DAILY_CONTROL_INPUT_PACK_KIND = "tp12_side_daily_control_input_pack_v1"
...
export const buildTp12SideDailyControlInputPack = async ({
  trainPackPath,
  oosPackPath,
  outPath,
  summaryOutPath,
  ...
  const summary = {
    status: "ok",
    kind: TP12_SIDE_DAILY_CONTROL_INPUT_PACK_KIND,
