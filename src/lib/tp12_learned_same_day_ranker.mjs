...
const FEATURE_SPEC = [
  ...
  feature("d0ClosePressurePctHigh", (row) => rankValue(row, "d0ClosePressurePctHigh")),
  feature("d0TradingValueRel20High", (row) => rankValue(row, "d0TradingValueRel20High")),
  feature("d0CloseLocationHigh", (row) => rankValue(row, "d0CloseLocationHigh")),
  feature("d0RangePctHigh", (row) => rankValue(row, "d0RangePctHigh")),
  feature("d0SideDailyAlignmentHigh", (row) => rankValue(row, "d0SideDailyAlignmentHigh")),
  feature("d0SideDailyPressureHigh", (row) => rankValue(row, "d0SideDailyPressureHigh")),
  feature("d0IntradayCloseStrengthHigh", (row) => rankValue(row, "d0IntradayCloseStrengthHigh")),
  feature("d0IntradayVwapHoldRatioHigh", (row) => rankValue(row, "d0IntradayVwapHoldRatioHigh")),
  ...
  feature(
    "d0ClosePressure_x_sideAlignment",
    (row) => rankValue(row, "d0ClosePressurePctHigh") * rankValue(row, "d0SideDailyAlignmentHigh"),
  ),
  feature(
    "d0CloseStrength_x_quality",
    (row) => rankValue(row, "d0IntradayCloseStrengthHigh") * rankValue(row, "maxClusterRowWilsonLBHigh"),
  ),
