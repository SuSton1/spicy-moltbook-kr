...
export const buildPerfectPrototypeDailyWinnerArchetypeRouter = ({ family, minArchetypeDates = 2, maxArchetypes = 4 } = {}) => {
  ...
  if (positiveRows.length < 2 || availableFeatures.length < 2) {
    return {
      ...family,
      ok: false,
      reason: "unsat_no_winner_archetypes",
      archetypes: [],
      summary: {
        ...(family?.summary ?? {}),
  ...
  return {
    ...family,
    ok,
    reason: ok ? null : "unsat_no_winner_archetypes",
    archetypes,
