...
export function renderTab(state: AppViewState, tab: Tab) {
  ...
  const label = titleForTab(tab, lang);
  return html`
    <a
      href=${href}
    ...
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          aria-label=${t("sessionLabel", lang)}
      ...
      <button
        ...
        title=${
          disableThinkingToggle
            ? t("disabledDuringOnboarding", lang)
            : t("toggleThinking", lang)
        }
      >
        ${icons.brain}
      </button>
...
export function renderThemeToggle(state: AppViewState) {
  ...
  return html`
    <div class="theme-toggle" style="--theme-index: ${index};">
      <div class="theme-toggle__track" role="group" aria-label=${t("theme", lang)}>
        <span class="theme-toggle__indicator"></span>
        <button
          class="theme-toggle__button ${state.theme === "system" ? "active" : ""}"
          @click=${applyTheme("system")}
          aria-pressed=${state.theme === "system"}
          aria-label=${t("themeSystem", lang)}
