...
export function renderApp(state: AppViewState) {
  ...
  const chatDisabledReason = state.connected ? null : t("gatewayDisconnected", lang);
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      <header class="topbar">
        <div class="topbar-left">
          <button
            ...
            title=${state.settings.navCollapsed ? t("expandSidebar", lang) : t("collapseSidebar", lang)}
            aria-label=${state.settings.navCollapsed ? t("expandSidebar", lang) : t("collapseSidebar", lang)}
          >
          ...
          <div class="brand">
            ...
            <div class="brand-text">
              <div class="brand-title">${t("brandTitle", lang)}</div>
              <div class="brand-sub">${t("brandSubtitle", lang)}</div>
            </div>
          </div>
        </div>
        <div class="topbar-status">
          <div class="pill">
            ...
            <span>${t("health", lang)}</span>
            <span class="mono">${state.connected ? t("statusOk", lang) : t("statusOffline", lang)}</span>
          </div>
          ${renderThemeToggle(state)}
          <label class="lang-select">
            <span class="sr-only">${t("language", lang)}</span>
            <select
              .value=${lang}
              @change=${(event: Event) => {
            ...
            >
              <option value="ko">${t("languageKo", lang)}</option>
              <option value="en">${t("languageEn", lang)}</option>
            </select>
          </label>
        </div>
      </header>
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ${TAB_GROUPS.map((group) => {
          ...
          return html`
            <div class="nav-group ${isGroupCollapsed && !hasActiveTab ? "nav-group--collapsed" : ""}">
              ...
              >
                <span class="nav-label__text">${t(group.labelKey, lang)}</span>
        ...
        <div class="nav-group nav-group--links">
          <div class="nav-label nav-label--static">
            <span class="nav-label__text">${t("resources", lang)}</span>
          </div>
          <div class="nav-group__items">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              title=${t("docsTitle", lang)}
            >
              <span class="nav-item__icon" aria-hidden="true">${icons.book}</span>
              <span class="nav-item__text">${t("docs", lang)}</span>
            </a>
          </div>
        </div>
      </aside>
      <main class="content ${isChat ? "content--chat" : ""}">
        <section class="content-header">
          <div>
            <div class="page-title">${titleForTab(state.tab, lang)}</div>
            <div class="page-sub">${subtitleForTab(state.tab, lang)}</div>
          </div>
          <div class="page-meta">
      ...
      ${
        !state.settings.languageAcknowledged
          ? html`
              <div class="lang-modal" role="dialog" aria-modal="true">
                <div class="lang-card">
                  <div class="lang-title">${t("languagePromptTitle", lang)}</div>
                  <div class="lang-sub">${t("languagePromptBody", lang)}</div>
