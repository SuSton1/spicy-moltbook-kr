...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config", "en")).toContain("openclaw.json");
  });
});
...
describe("TAB_GROUPS", () => {
  it("contains all expected groups", () => {
    const labels = TAB_GROUPS.map((g) => g.labelKey);
    expect(labels).toContain("navGroupChat");
    expect(labels).toContain("navGroupControl");
    expect(labels).toContain("navGroupAgent");
    expect(labels).toContain("navGroupSettings");
  });
