...
const usage = () => {
  console.error(`Usage:
  node tools/report_perfect_prototype_low_gap_top_support_atlas_oos.mjs \\
    --artifact=<support_atlas_artifact.json> \\
...
const main = async () => {
  ...
  const summary = summarizePerfectPrototypeSupportAtlasSelections({
