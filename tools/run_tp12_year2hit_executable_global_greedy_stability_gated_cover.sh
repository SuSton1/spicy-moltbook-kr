...
RUN_ID="${RUN_ID:-tp12_year2hit_executable_global_greedy_stability_gated_cover_v1}"
OUT_DIR="${OUT_DIR:-artifacts/runs/${RUN_ID}/train_only}"
CONTRACT_PATH="${CONTRACT_PATH:-meta/tp12_year2hit_executable_global_greedy_stability_gated_cover_contract.json}"
...
TRAIN_REPLAY_DIR="${TRAIN_REPLAY_DIR:-${OUT_DIR}/global_greedy_train_cover_replay}"
SURVIVORS_PATH="${SURVIVORS_PATH:-${GLOBAL_COVER_DIR}/micro_split_global_greedy_final_survivors.jsonl}"
