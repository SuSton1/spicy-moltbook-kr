...
family = buildPerfectPrototypeDailyMechanismArchetypeRouter({ family, minArchetypeDates: 2, maxArchetypes: 4 })
...
assert.ok((family.summary?.mechanismHypothesisCount ?? 0) >= 3)
assert.ok((family.summary?.tradeGateCandidateCount ?? 0) > 0)
