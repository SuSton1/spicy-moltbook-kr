...
const usage = () => {
  console.error(`Usage:
  node tools/report_perfect_prototype_low_gap_top_support_scorecard_oos.mjs \
    --artifact=<support_scorecard_artifact.json> \
...
const main = async () => {
  ...
  const summary = summarizePerfectPrototypeSupportScorecardSelections({
